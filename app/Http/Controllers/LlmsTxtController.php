...
class LlmsTxtController extends Controller
{
    ...
    private function indexBody(): string
    {
        ...
        $lines = array_merge($lines, [
            ...
            '## Contact & legal',
            '',
            '- [Contact]('.route('contact.create').'): Preferred route for bookings, coaching and builds. Statutory contact details are on the legal page.',
            '- [Legal]('.route('legal.index').'): Supplier disclosure and the full document set.',
            '- [Privacy Policy]('.route('legal.privacy').') (POPIA).',
            '- [Terms]('.route('legal.terms').').',
            '- [Shipping Policy]('.route('legal.shipping').').',
            '- [Returns & Refunds]('.route('legal.refunds').').',
            '',
            '## Optional',
            '',
